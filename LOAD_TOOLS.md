...
- Open: http://localhost:8080/audio-tools.html
...
**Option C: Main App**
- Main Noir App: http://localhost:8080
...
2. **Audio Tools Index** (Links to all tools)
   - URL: http://localhost:8080/audio-tools.html
   - Quick access to all standalone tools

3. **Reverse Audio Tool**
   - URL: http://localhost:8080/reverse-audio.html
   - Reverse audio playback

4. **Speed/Tempo Tool**
   - URL: http://localhost:8080/speed-audio.html
   - Change speed (0.25x to 4x)
   - Custom input for precise control

5. **Pitch Shift Tool**
   - URL: http://localhost:8080/pitch-audio.html
...
- http://localhost:8080/audio-tools.html (Tools Index)
...
- Check that you're using http://localhost:8080 (not https)
